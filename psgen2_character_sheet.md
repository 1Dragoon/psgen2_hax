...
> (I figure there's a flag for "can't re-enchant" in here somewhere for those weapons that can't be modified.)
...
> All other bit fields appear like they might be ignored, but I'm uncertain. Some might be used to define how much an enchantment costs.
